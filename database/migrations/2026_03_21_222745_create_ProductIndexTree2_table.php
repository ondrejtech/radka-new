...
return new class extends Migration
{
    ...
    {
        Schema::create('ProductIndexTree2', function (Blueprint $table) {
            $table->string('IndexCode', 64)->primary();
            $table->string('CommodityCode', 64)->nullable()->index('fk_indextree2_commodity');
    ...
    {
        Schema::dropIfExists('ProductIndexTree2');
    }
};
